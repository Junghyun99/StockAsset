...
class DomesticAsset5RealEngine(FullExposureEngine):
    """국내 자산5분법 — 코스피 200, 나스닥 100, 국고채 10년, 미국채 10년 금 현물  Full Exposure 전략 엔진.

    - 자산군 A: [069500(KODEX 200), 133690(TIGER 미국나스닥100)]
    - 자산군 B: [365780(ACE 국고채10년), 305080(TIGER 미국채10년선물), 411060(ACE KRX금현물)]
    - exposure=1.0 항상 유지 (FullExposureEngine 상속)
    - A:B 비율 = 0.7:0.3 
      (레짐상 저금리 가기 어려움)
    """
    ...
    ASSET_GROUPS: dict = {
        'A': ['069500.KS', '133690.KS'],
        'B': ['365780.KS', '305080.KS', '411060.KS'],
    }
    REBALANCE_RATIO_A: float = 0.7
